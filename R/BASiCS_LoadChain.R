#' @title Loads pre-computed MCMC chains generated by the \code{\link[BASiCS]{BASiCS_MCMC}} function
#'
#' @description  Loads pre-computed MCMC chains generated by the \code{\link[BASiCS]{BASiCS_MCMC}} function, creating
