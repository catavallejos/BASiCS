...
.onAttach = function(libname, pkgname) {
  ...
  msg = "BASiCS now (v1.0.0 onwards) utilizes the SingleCellExperiment class to collect the dataset information: expression counts, information on spike-ins and batch information. For more information use vignette('BASiCS'). \n 
