...
#' @param Case1 If true, a cell population containing the first 50 biological genes is generates. If false, the second set of 50 biological genes is used to simulated the population.
#' This is used to generate two populations for differential testing.
#'
...
#' It contains 70 genes (50 biological and 20 spike-in) and 20 cells.
#'
#' @examples
...
makeExampleBASiCS_Data <- function(WithBatch = FALSE, WithSpikes = TRUE, Case1 = TRUE)
{
