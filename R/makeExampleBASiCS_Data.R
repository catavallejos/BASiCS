...
#' model in BASiCS (Vallejos et al 2015). This is used to illustrate BASiCS in the package examples and in the vignette.
#'
#' @param WithBatch If \code{TRUE}, 2 batches are generated (each of them containing 10 cells). Default value: \code{WithBatch = FALSE}.
#' @param WithSpikes If \code{TRUE}, the simulated dataset contains 20 spike-in genes. Default value: \code{WithSpikes = TRUE}.
