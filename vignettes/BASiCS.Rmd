...
--- to perform these analyses. More recently, @eling2017robust extendeded BASiCS 
...
BASiCS model will be used [@eling2017robust]. The latter infers a global 
...
To use the regression BASiCS model [@eling2017robust], please set 
...
Beyond its original implementation, BASiCS has been extended to adress 
...
replicates [@eling2017robust]. Therefore, `BASiCS_MCMC` will fail to run if a 
...
Additionally, when creating the `BASiCS_Data` object, the `SpikeInfo` slot must 
...
choices, please refer to @eling2017robust. 
...
@eling2017robust further extended this model by addressing the
...
are described in @vallejos2015basics, @vallejos2016beyond and @eling2017robust. 
