...
```{r quick-start-HVGdetection, fig.height = 15, fig.width = 10}
...
You can access the results of these tests using `format`. You must specify which
...
```{r testde-resdisp}
head(format(Test, Which = "ResDisp"))
