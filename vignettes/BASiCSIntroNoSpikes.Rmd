...
MCMC_Output <- BASiCS_MCMC(Data, N = 50000, Thin = 20, Burn = 25000, 
                           PrintProgress = FALSE) #Start = Start
...
plot(MCMC_Output1, Param = "mu", Gene = 10)
abline(h = Mu[10], col = "red")
plot(MCMC_Output1, Param = "mu", Gene = 100)
abline(h = Mu[100], col = "red")
plot(MCMC_Output1, Param = "delta", Gene = 1)
...
plot(MCMC_Output1, Param = "theta", Batch = 1) 
abline(h = Theta1, col = "red")
plot(MCMC_Output1, Param = "theta", Batch = 2) 
