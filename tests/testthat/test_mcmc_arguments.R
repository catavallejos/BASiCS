...
test_that("MCMC fails for one or multiple arguments", {
  ...
  expect_error(run_BASiCS_MCMC(Data = DataSpikes),
               regexp = "argument \"N\" is missing, with no default")
  expect_error(run_BASiCS_MCMC(Data = DataSpikes, N = 50),
  ...
  expect_error(run_BASiCS_MCMC(Data = DataSpikesBatchNotFactor, N = 20, Thin = 2,
  ...
  expect_error(run_BASiCS_MCMC(Data = DataSpikes, N = 50,
                           ...
                           WithSpikes = TRUE), NA)
  expect_error(run_BASiCS_MCMC(Data = DataNoSpikes, N = 50,
                           Thin = 5, Burn = 25, Regression = FALSE,
                           WithSpikes = TRUE),
  ...
  expect_error(run_BASiCS_MCMC(Data = Data2, N = 50,
                           Thin = 5, Burn = 25, Regression = FALSE,
                           WithSpikes = TRUE),
  ...
  expect_error(run_BASiCS_MCMC(Data = DataSpikes, N = 50,
                           Thin = 5, Burn = 25, Regression = FALSE,
                           WithSpikes = FALSE), NA)
  expect_error(run_BASiCS_MCMC(Data = DataSpikesNoBatch, N = 50,
                           Thin = 5, Burn = 25, Regression = FALSE,
                           WithSpikes = FALSE),
  ...
  expect_error(run_BASiCS_MCMC(Data = sce, N = 50,
                           Thin = 5, Burn = 25, Regression = FALSE,
                           WithSpikes = FALSE),
