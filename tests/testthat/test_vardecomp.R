...
test_that("Variance decomposition is correct", 
{
  ...
  expect_equal(round(VD$BioVarGlobal[1:5],3), 
                        BioVarGlobal0)
  TechVarGlobal0 <- c(0.203, 0.210, 0.250, 0.263, 0.276)
  expect_equal(round(VD$TechVarGlobal[1:5],3), 
                        TechVarGlobal0)
  BioVarBatch10 <- c(0.755, 0.739, 0.662, 0.630, 0.636)
  expect_equal(round(VD$BioVarBatch1[1:5],3), 
                        BioVarBatch10)
  TechVarBatch10 <- c(0.205, 0.219, 0.244, 0.258, 0.271)
  expect_equal(round(VD$TechBatch1[1:5],3), 
                        TechVarBatch10) 
